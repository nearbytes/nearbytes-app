...
- `docs/specs/ui/system/mockRuntime.ts`
- `docs/specs/ui/system/runtime.ts`
- `docs/specs/ui/system/runtimeContracts.ts`
...
- `ui/src/App.svelte` provides the live browser/runtime adapter through `docs/specs/ui/system/runtime.ts`
- `ui/src/lib/design/runtime.ts` is the app-owned implementation of that runtime adapter
...
- Shared surfaces must depend on `docs/specs/ui/system/runtime.ts` instead of importing `ui/src/lib/*` directly
- `docs/specs/ui/system/mockRuntime.ts` is the only runtime implementation used by the studio
