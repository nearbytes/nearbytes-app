...
try {
  console.error('[dev2-iphone-lan] preparing desktop + iPhone LAN environment');
  ...
  console.error('[dev2-iphone-lan] ready for manual LAN testing');
  ...
  console.error('[dev2-iphone-lan] FAILED', error instanceof Error ? error.stack ?? error.message : String(error));
  await shutdown(1);
}
