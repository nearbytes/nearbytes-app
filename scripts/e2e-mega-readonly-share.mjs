 ...
 * Optional:
 *   - NEARBYTES_E2E_SKIP_MEGA_WIPE=0   Enable destructive whole-account wipe before the run.
 *
...
const MIRROR_FILE_TIMEOUT_MS = readPositiveIntEnv('NEARBYTES_E2E_MEGA_MIRROR_FILE_TIMEOUT_MS', 180_000);
