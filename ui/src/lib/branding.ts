...
const DEFAULT_PRESETS: NearbytesThemeSettings[] = [
  {
    ...
    palette: {
      ...
      accent: '#5c4f44',
      accentStrong: '#3e342c',
      accentSoft: 'rgba(92, 79, 68, 0.09)',
      accentText: '#ffffff',
      textMain: 'rgba(0, 0, 0, 0.92)',
      textSoft: 'rgba(60, 60, 67, 0.65)',
      textFaint: 'rgba(60, 60, 67, 0.40)',
      success: '#34C759',
      warning: '#FF9500',
      danger: '#FF3B30',
    },
  ...
  },
  {
    ...
    palette: {
      ...
      textSoft: 'rgba(235, 235, 245, 0.65)',
  ...
  },
  {
    ...
    palette: {
      ...
      accent: '#7ab8ff',
      accentStrong: '#a3cdff',
      accentSoft: 'rgba(122, 184, 255, 0.12)',
      accentText: '#f0f4ff',
      textMain: 'rgba(241, 245, 249, 0.96)',
      textSoft: 'rgba(203, 213, 225, 0.68)',
  ...
  },
  {
    ...
    palette: {
      id: 'mono-scarlet',
      label: 'Warm Stone',
      description: 'Warm porcelain surfaces with graphite text and earthy stone accents — soft and clear.',
      surfaceStyle: 'flat',
      appBg: '#f5f4f1',
      ...
      accent: '#6d6058',
      accentStrong: '#4e443c',
      accentSoft: 'rgba(109, 96, 88, 0.09)',
      accentText: '#ffffff',
      textMain: 'rgba(28, 28, 30, 0.94)',
      textSoft: 'rgba(60, 60, 67, 0.62)',
      textFaint: 'rgba(60, 60, 67, 0.38)',
      success: '#34C759',
      warning: '#FF9500',
      danger: '#FF3B30',
    },
